...
########################################################################################################################
#        Функция для формирования бинарных файлов npy с распределениями гидрометеорологических параметров              #
...
# countries_tif --- geotiff файл с границами государств
# land_tif      --- geotiff файл с типами ландшафтов
# START         --- начальная точка, для которой формируется распределение, например 1е января - '01-01'
# STOP          --- конечная точка, для которой формируется распределение, например 30е января - '01-30'
