...
#########################################################################################################################
# Функция для объединения климатических данных, записанных в файлах формата netCDF и данных об урожайности, записанных  #
#                                            в файлах формата csv                                                       #
#########################################################################################################################
# country         --- название страны
# netCDf_dir      --- путь до папки, в которой расположенные заранее подготовленные климатические данные
# crop_data       --- путь до файла csv с урожайностью с/х культур по странам
# fertilizer_data --- путь до файла csv с информацией об использованных удобрениях
# tractor_data    --- путь до файла csv с информацией об использовании техники в сельском хозяйстве
# land_data       --- путь до файла csv с информацией об использованных землях в качестве с/х угодий
